...
(function() {
  var A6, Canvas, Image, fs, request;
  ...
  A6 = (function() {
    ...
    function A6(caption, pic, date, callback) {
    ...
    A6.prototype.drawImage = function() {
      var _this = this;
      return request.get({
        url: this.pic,
        encoding: null
    ...
    A6.prototype.drawText = function() {
    ...
    A6.prototype.callbackCounter = function(who) {
      this.i++;
      console.log(who);
      if (this.i === 2) {
    ...
    A6.prototype.writeFile = function() {
  ...
  module.exports = {
    make: function(size, caption, pic, date, callback) {
      var test;
      return test = new A6(caption, pic, date, function(resp) {
